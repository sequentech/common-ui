  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v6.1.6.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v6.1.6.js"></script>'},
            {selector:'body',html:'<script src="/SequentPlugins-v6.1.6.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentThemes-v6.1.6.js': ['SequentThemes.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v6.1.6.js': 'temp/app.js',
          'dist/libCommon-v6.1.6.js': 'temp/lib.js',
          'dist/libnocompat-v6.1.6.js': 'temp/libnocompat.js',
