  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v5.2.0.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v5.2.0.js"></script>'},
            {selector:'body',html:'<script src="/avPlugins-v5.2.0.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/avThemes-v5.2.0.js': ['avThemes.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v5.2.0.js': 'temp/app.js',
          'dist/libCommon-v5.2.0.js': 'temp/lib.js',
          'dist/libnocompat-v5.2.0.js': 'temp/libnocompat.js',
