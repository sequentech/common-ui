  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v10.2.0.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v10.2.0.js"></script>'},
            {selector:'body',html:'<script src="/SequentPlugins-v10.2.0.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentThemes-v10.2.0.js': ['SequentThemes.js'],
          'dist/SequentPlugins-v10.2.0.js': ['plugins/**/*.js']
        }
      },
      postUglify: {
        files: {
          'dist/libCommon-v10.2.0.js': ['dist/libCommon-v10.2.0.js', 'node_modules/i18next/dist/umd/i18next.js']
        }
      },
    },
    "merge-json": {
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v10.2.0.js': 'temp/app.js',
          'dist/libCommon-v10.2.0.js': ['temp/lib.js'],
          'dist/libnocompat-v10.2.0.js': 'temp/libnocompat.js',
