    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v10.1.0.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v10.1.0.js"></script>'},
            {selector:'body',html:'<script src="/SequentPlugins-v10.1.0.js"></script>'},
