  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<!--[if lte IE 8]><script src="/libcompat-v103.111.1.js"></script><![endif]--><!--[if gte IE 9]><script src="/libnocompat-v103.111.1.js"></script><![endif]--><!--[if !IE]><!--><script src="/libnocompat-v103.111.1.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/appCommon-v103.111.1.js"></script>'},
            {selector:'body',html:'<script src="/avPlugins-v103.111.1.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/avThemes-v103.111.1.js': ['avThemes.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v103.111.1.js': 'temp/app.js',
          'dist/libCommon-v103.111.1.js': 'temp/lib.js',
          'dist/libnocompat-v103.111.1.js': 'temp/libnocompat.js',
          'dist/libcompat-v103.111.1.js': 'temp/libcompat.js',
