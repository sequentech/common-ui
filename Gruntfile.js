  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v7.1.0.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v7.1.0.js"></script>'},
            {selector:'body',html:'<script src="/SequentPlugins-v7.1.0.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentThemes-v7.1.0.js': ['SequentThemes.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v7.1.0.js': 'temp/app.js',
          'dist/libCommon-v7.1.0.js': 'temp/lib.js',
          'dist/libnocompat-v7.1.0.js': 'temp/libnocompat.js',
