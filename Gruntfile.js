  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v5.0.7.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v5.0.7.js"></script>'},
            {selector:'body',html:'<script src="/avPlugins-v5.0.7.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/avThemes-v5.0.7.js': ['avThemes.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v5.0.7.js': 'temp/app.js',
          'dist/libCommon-v5.0.7.js': 'temp/lib.js',
          'dist/libnocompat-v5.0.7.js': 'temp/libnocompat.js',
