  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v4.0.1.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v4.0.1.js"></script>'},
            {selector:'body',html:'<script src="/avPlugins-v4.0.1.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/avThemes-v4.0.1.js': ['avThemes.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v4.0.1.js': 'temp/app.js',
          'dist/libCommon-v4.0.1.js': 'temp/lib.js',
          'dist/libnocompat-v4.0.1.js': 'temp/libnocompat.js',
