  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v10.0.1.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v10.0.1.js"></script>'},
            {selector:'body',html:'<script src="/SequentPlugins-v10.0.1.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentThemes-v10.0.1.js': ['SequentThemes.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v10.0.1.js': 'temp/app.js',
          'dist/libCommon-v10.0.1.js': 'temp/lib.js',
          'dist/libnocompat-v10.0.1.js': 'temp/libnocompat.js',
