  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v10.4.2.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v10.4.2.js"></script>'},
            {selector:'body',html:'<script src="/SequentPlugins-v10.4.2.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentThemes-v10.4.2.js': ['SequentThemes.js'],
          'dist/SequentPlugins-v10.4.2.js': ['plugins/**/*.js']
        }
      },
      postUglify: {
        files: {
          'dist/libCommon-v10.4.2.js': ['dist/libCommon-v10.4.2.js', 'node_modules/i18next/dist/umd/i18next.js']
        }
      },
    },
    "merge-json": {
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v10.4.2.js': 'temp/app.js',
          'dist/libCommon-v10.4.2.js': ['temp/lib.js'],
          'dist/libnocompat-v10.4.2.js': 'temp/libnocompat.js',
