  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<!--[if lte IE 8]><script src="/libcompat-v103111.2.js"></script><![endif]--><!--[if gte IE 9]><script src="/libnocompat-v103111.2.js"></script><![endif]--><!--[if !IE]><!--><script src="/libnocompat-v103111.2.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/appCommon-v103111.2.js"></script>'},
            {selector:'body',html:'<script src="/avPlugins-v103111.2.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/avThemes-v103111.2.js': ['avThemes.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v103111.2.js': 'temp/app.js',
          'dist/libCommon-v103111.2.js': 'temp/lib.js',
          'dist/libnocompat-v103111.2.js': 'temp/libnocompat.js',
          'dist/libcompat-v103111.2.js': 'temp/libcompat.js',
