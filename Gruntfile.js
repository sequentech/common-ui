  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<script src="/libnocompat-v9.0.0.js"></script>'},
            ...
            {selector:'body',html:'<script src="/appCommon-v9.0.0.js"></script>'},
            {selector:'body',html:'<script src="/SequentPlugins-v9.0.0.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentThemes-v9.0.0.js': ['SequentThemes.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/appCommon-v9.0.0.js': 'temp/app.js',
          'dist/libCommon-v9.0.0.js': 'temp/lib.js',
          'dist/libnocompat-v9.0.0.js': 'temp/libnocompat.js',
