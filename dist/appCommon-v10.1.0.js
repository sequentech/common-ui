...
angular.module("avTest", []), angular.module("avTest").controller("UnitTestE2EController", [ "$scope", "$location", "ConfigService", function($scope, $location, ConfigService) {
    ...
    $templateCache.put("avUi/common-footer-directive/common-footer-directive.html", '<nav class="hidden" ng-cloak av-affix-bottom ng-if="!float" class="footer-wrapper" role="navigation"><div class="container footer-container row"><i ng-i18next="[html:i18next]({url: configService.organization.orgUrl, name: configService.organization.orgName})avCommon.poweredBy"></i></div></nav><nav ng-if="!!float" class="footer-wrapper" role="navigation"><div class="container footer-container row"><i ng-i18next="[html:i18next]({url: configService.organization.orgUrl, name: configService.organization.orgName})avCommon.poweredBy"></i></div></nav>'), 
