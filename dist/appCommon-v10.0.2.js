    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            scope.isAdmin = !1, autheventid === adminId && (scope.isAdmin = !0), scope.resendAuthCode = function(field) {
                ...
                }), authURI = provider.public_info.authorization_endpoint + "?response_type=id_token&client_id=" + encodeURIComponent(provider.public_info.client_id) + "&scope=" + encodeURIComponent("openid") + "&redirect_uri=" + encodeURIComponent($window.location.origin + "/election/login-openid-connect-redirect") + "&state=" + randomState + "&nonce=" + authURI, 
    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            scope.langs = $i18next.options.lngWhitelist, element.on("click", function() {
                ...
                $i18next.options.lng = lang, $i18next.options.useLocalStorage = !0, angular.isDefined($window.i18nOverride) && $window.i18n.preload([ lang ], function() {
