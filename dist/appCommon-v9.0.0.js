    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            scope.isAdmin = !1, autheventid === adminId && (scope.isAdmin = !0), scope.resendAuthCode = function(field) {
                ...
                var authevent;
                altAuthMethod !== scope.current_alt_auth_method_id && ("smart-link" !== scope.selectedAltMethod && "smart-link" === altAuthMethod || (authevent = angular.copy(scope.base_authevent), 
