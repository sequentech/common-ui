...
} ]), angular.module("avUi").directive("avChangeLang", [ "$i18next", "$timeout", "ipCookie", "angularLoad", "amMoment", "ConfigService", function($i18next, $timeout, ipCookie, angularLoad, amMoment, ConfigService) {
    function link(scope, element, attrs) {
        scope.deflang = window.i18n.lng(), angular.element("#ng-app").attr("lang", scope.deflang), 
        scope.langs = $i18next.options.lngWhitelist, scope.triggerClick = function($event) {
            switch ($event.which) {
              case 13:
              case 32:
                $timeout(function() {
...
angular.module("jm.i18next").config([ "$i18nextProvider", "ConfigServiceProvider", function($i18nextProvider, ConfigServiceProvider) {
    ...
    $templateCache.put("avUi/change-lang-directive/change-lang-directive.html", '<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">{{ deflang }} <span class="caret"></span></a><ul class="dropdown-menu" role="menu"><li ng-repeat="lang in langs"><a ng-click="changeLang(lang)" ng-keypress="triggerClick($event)" tabindex="0">{{lang}}</a></li></ul>'), 
